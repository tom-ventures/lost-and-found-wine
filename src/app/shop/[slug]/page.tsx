          ...
          <div className="relative aspect-[3/4] bg-brand-surface border border-brand-border">
            {product.image_url || wine?.image_url ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Image src="https://images.squarespace-cdn.com/content/v1/5df198c9866fde1a352aa92e/1576118172230-796H1E52GYKJ6Z5S7TFJ/Logo_360_Whitex.png" alt="" width={100} height={100} className="opacity-20 object-contain" />
              </div>
            )}
          </div>
